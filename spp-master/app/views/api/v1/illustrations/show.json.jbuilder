...
json.data do
  ...
  json.isFlagged @illustration.flagged?
  ...
  json.downloadLinks ["High Resolution", "Low Resolution"].each do |type|
    json.type type 
    json.href download_illustrations_url(@illustration, style: (type=="High Resolution") ? "original" : "large")
  end
