	...
	Croppic.prototype = {
      ...
      /*INIT DRAGGING*/
		...
		createCropControls: function(){
			...
			if(that.options.doubleZoomControls){ html =  '<div class="cropControls cropControlsCrop">'+ cropControlZoomMuchIn + cropControlZoomMuchOut + cropControlSave + cropControlReset + '</div>'; }
			else{ html =  '<div class="cropControls cropControlsCrop">' + cropControlSave + cropControlReset + '</div>'; }
