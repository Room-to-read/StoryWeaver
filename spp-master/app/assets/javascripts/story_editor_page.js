function StoryEditorPage(){
  ...
  var updateLevelBand = function(level_band){
    reading_level_preview_text.attr('src', '/assets/level_bands/Level_'+ rdLevel + '_' + level_band +  '.png');
  }
    ...
    $('.story_reading_level').change(function(){
      ...
      $.ajax({
        ...
        success: function(data){
          updateLevelBand(data["level_band"]);
        }
      });
