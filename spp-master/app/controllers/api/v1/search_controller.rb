...
# /api/v1/books-search
  def books_search
    ...
    search_obj = Querysearch::Books.new(common_params, current_user, false)
...
# /api/v1/lists-search
  def lists_search
    ...
    search_obj = Listsearch::Lists.new(list_params, nil, false, curr_session)
  ...
  def books_for_translation
    ...
    nObj = Querysearch::Books.new(common_params, nil, false)
    results = nObj.search
