...
class StoriesController < ApplicationController
  before_action :authenticate_user!, except: [:show, :other_reading_levels, :versions, :cover, :start, :translate, :translate_suggestions, :show_in_iframe, :update_story_read]
...
def download_story
 ...
 def show_selected_stories
  ...
  def level_band
    ...
    lb = story.language.level_band ?  story.language.level_band : "English"
    render json: {"level_band" => lb}
  end
