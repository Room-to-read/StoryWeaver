...
ActiveRecord::Schema.define(version: 20171205113518) do
  ...
  create_table "temp_illustrators_illustrations", id: false, force: true do |t|
    t.integer "user_id",         null: false
    t.integer "illustration_id", null: false
  end

  add_index "temp_illustrators_illustrations", ["user_id", "illustration_id"], name: "temp_illustrator_illustration_index", using: :btree
