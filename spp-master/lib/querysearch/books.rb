module Querysearch
  class Books
    ...
    def search
      ...
      #sort_category = @current_user ? (@current_user.content_manager? ? "content_manager_" + sort_category.to_s : "user" + sort_category.to_s) : sort_category if sort_category

      #if search_params[:cache] == "true"
      #  get_cache(sort_category,params[:page])
      #else
          ...
          metadata: 
            {
              ...
              perPage:     query_results.per_page,
              page:         query_results.current_page,
              totalPages:  query_results.total_pages
            }
        }
