Rails.application.routes.draw do
  ...
  scope :v0 do
    ...
    post '/stories/update_story_read', to: 'stories#update_story_read', as: :update_story_read
    post '/stories/show_selected_stories', to: 'stories#show_selected_stories', as: :show_selected_stories
    ...
    get '/stories/bulk_download', to: 'stories#bulk_download', as: :bulk_download
    #get '/stories/show_selected_stories', to: 'stories#show_selected_stories', as: :show_selected_stories
    ...
    get '/stories/:id/new_flag_story', to: 'stories#new_flag_story' , as: :new_flag_story
    post '/stories/flag_story/:id', to: 'stories#flag_story' , as: :flag_story
    ...
    get "/start" , to: 'home#index', as: :start_new_story
    get "/translate_suggestions" , to: 'stories#translate_suggestions' , as: :stories_translate_suggestions
    ...
    get '/freedom_to_read', to: 'contents#freedom_to_read', as: :v0_freedom_to_read
  ...
  get '/freedom_to_read', to: 'contents#freedom_to_read', as: :freedom_to_read
