...
#SHOW
  context "SHOW/GET Story Details" do
    ...
    it "should show the story details" do
      ...
      expect(ok: true)
      expect(JSON.parse(response.body)['data'].keys).to contain_exactly("name", "id", "language", "level", "slug", "status", "liked", "description", "isTranslation", "readsCount", "likesCount", "readingListMembershipCount", "copyrightNotice", "orientation", "recommended", "canEdit", "publisher", "publishedTime", "donorName", "contest", "similarBooks", "translations", "coverImage", "tags", "downloadLinks", "authors", "originalStory", "illustrators", "lists", "isFlagged", "editorsPick", "versionCount", "languageCount", "availableForOfflineMode", "googleFormDownloadLink", "externalLink", "isRelevelled", "photographers")
      ...
      expect_json('data.downloadLinks.0.type', 'Low resolution pdf')
