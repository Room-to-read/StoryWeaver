...
Scenario: Login as user to validate home page
  ...
  Then I should see "Except where otherwise noted, content on this site is licensed under a Creative Commons Attribution 4.0 Licence International (CC-BY-4.0)"
