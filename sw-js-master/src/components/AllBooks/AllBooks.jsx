        ...
        searchResultsEl = (
          <Block noHorizontalPadding noVerticalPadding>
            <Tabs onTabChange={this.onTabChange} activeTabIndex={activeTabIndex}>
              <Tab key="books" title={t('global.story', 2)} shouldUnloadContent={true}>
                {booksSearchResultsEl}
              </Tab>
              <Tab key="lists" title={t('global.list', 2)} shouldUnloadContent={true}>
              ...
              <Tab key="images" title={t('global.image', 2)} shouldUnloadContent={true}>
                <ImagesSearchResultsContainer
                  applyFilter={applyFilter}
                  removeFilter={removeFilter}
                  onSortOptionChanged={onSortOptionChanged}
              ...
              </Tab>
              {
                ...
                ?
                <Tab key="people" title={t('global.person', 2)} active={activeTabIndex === tabIndexes.people} shouldUnloadContent={true}>
              ...
              }
              {
                ...
                ?
                <Tab key="organisations" title={t('global.organisation', 2)} active={activeTabIndex === tabIndexes.organisations} shouldUnloadContent={true}>
                  <PeopleSearchResultsContainer
                    applyFilter={applyFilter}
                    removeFilter={removeFilter}
                    onSortOptionChanged={onSortOptionChanged}
