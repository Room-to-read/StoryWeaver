...
class IllustrationUploadModal extends Component {
  ...
  isFormValid = () => {
    const { name, category_ids, style_ids, license_type, image, termsOfUse } = this.state;
    this.setState({ isFormValid: (name.length > 0 
        && image 
            ...
            <Dropdown
              ...
              toggleEl={
                <TextField
                  ...
                  onChange={this.onIllustratorChange.bind(this, index, 'email')}
