...
class SiteHeader extends Component {
  ...
  onCreateClicked = () => {
    const { viewport, addNotification, isLoggedIn, openAuthModal, t } = this.props;
  ...
  render() {
    ...
    const mapRoleToLinks = {
      content_manager: ['content-manager-dashboard', 'contest-dashboard', 'blog-dashboard', 'rating-dashboard', 'translation-dashboard', 'analytics'],
      promotion_manager: ['contest-dashboard', 'blog-dashboard'],
      outreach_manager: ['analytics'],
    ...
    if (isFetchingMe) {
      ...
      userInfoEls = (
        <Dropdown
          toggleEl={<SiteNavLink parentClassName={`${baseClassName}__dropdown-link`} respondFontSize truncateLongText caret='down' href={links.dashboard()}>{user.first_name}</SiteNavLink>}
