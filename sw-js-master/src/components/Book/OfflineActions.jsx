        ...
        return (
          ...
          >
            <List nowrap>
              ...
              ?
              <Link fullWidth legend={t('Book.please-log-in-add-story-to-offline')} onClick={openAuthModal}>
                <SvgIcon name="user"/> {t('global.log-in')}
              </Link>
              :
              <Link fullWidth legend={t('Book.please-log-in-add-story-to-offline')} href={links.login()}>
                <SvgIcon name="user"/> {t('global.log-in')}
              </Link>
              }
            </List>
