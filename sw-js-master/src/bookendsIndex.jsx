...
import { logoutWorkflow, openAuthModal } from './redux/userActions';
...
@connect(mapStateToProps, { initViewport, logoutWorkflow, openAuthModal, changeLanguage })
...
@connect(mapStateToProps, { initViewport, subscribeWorkflow, recordLocalization, changeLanguage })
export class SiteFooterContainer extends Component {
  ...
  render() {
    const { isLoggedIn, isSubscribed, isFetchingSubscribe, subscribeWorkflow } = this.props
    return (
      <div className="pb-body">
        <SiteFooter
