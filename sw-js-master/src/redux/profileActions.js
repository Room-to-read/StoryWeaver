...
export const fetchProfileWorkflow = (slug, profileType, perPage) => {
  const fetchPromise = mapModelsToNames[profileType].fetchProfile(slug, 20);
...
export const loadMoreWorkflow = (profileType, profileName, slug, collection, page, perPage) => {
  const fetchPromise = mapModelsToNames[profileType].fetchMore(profileName, slug, collection, page, 20);
